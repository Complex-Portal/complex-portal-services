...
public class MusicImportConfig {
    ...
    @Bean
    public MusicComplexReader musicComplexReader(FileConfiguration fileConfiguration) {
        return MusicComplexReader.builder().fileConfiguration(fileConfiguration).build();
    }
